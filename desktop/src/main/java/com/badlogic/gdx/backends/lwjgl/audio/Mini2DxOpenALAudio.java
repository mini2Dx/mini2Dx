 ...
 */
public class Mini2DxOpenALAudio implements Mini2DxAudio {
	...
	private Array<SoundCompletionListener> soundCompletionListeners = new Array<SoundCompletionListener>(false, 1, SoundCompletionListener.class);
