...
public class LongIntMapTest {
	...
	public void testGet(){
		...
		Assert.assertEquals(103, map.get(Long.MIN_VALUE, -1));
		Assert.assertEquals(101, map.get(Long.MIN_VALUE + 1, -1));
		Assert.assertEquals(102, map.get(Long.MIN_VALUE + 2, -1));
		Assert.assertEquals(102, map.get(Long.MIN_VALUE + 2, -1));
		Assert.assertEquals(-1, map.get(Long.MAX_VALUE, -1));
		Assert.assertEquals(3, map.size);
	}
	...
	public void testRemove(){
		...
		Assert.assertEquals(103, map.remove(Long.MIN_VALUE, -1));
		Assert.assertEquals(2, map.size);
		Assert.assertEquals(101, map.remove(Long.MIN_VALUE + 1, -1));
		Assert.assertEquals(1, map.size);
		Assert.assertEquals(102, map.remove(Long.MIN_VALUE + 2, -1));
		Assert.assertEquals(0, map.size);
