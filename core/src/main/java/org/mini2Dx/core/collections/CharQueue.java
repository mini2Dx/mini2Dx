...
public class CharQueue {
    ...
    public Iterator<Character> iterator () {
        if (iterable == null) iterable = new CharQueueIterable(this);
    ...
    public boolean equals (Object o) {
        ...
        if (!(o instanceof CharQueue)) return false;

        CharQueue q = (CharQueue)o;
        final int size = this.size;
    ...
    static public class CharQueueIterator implements Iterator<Character>, Iterable<Character> {
        ...
        public CharQueueIterator (CharQueue queue) {
            this(queue, true);
        }

        public CharQueueIterator (CharQueue queue, boolean allowRemove) {
            this.queue = queue;
    ...
    static public class CharQueueIterable implements Iterable<Character> {
        private final CharQueue queue;
        private final boolean allowRemove;
        private CharQueueIterator iterator1, iterator2;

        public CharQueueIterable (CharQueue queue) {
            this(queue, true);
        }

        public CharQueueIterable (CharQueue queue, boolean allowRemove) {
            this.queue = queue;
            this.allowRemove = allowRemove;
        }
        ...
        public Iterator<Character> iterator () {
            if (iterator1 == null) {
                iterator1 = new CharQueueIterator(queue, allowRemove);
                iterator2 = new CharQueueIterator(queue, allowRemove);
            }
            if (!iterator1.valid) {
                iterator1.index = 0;
