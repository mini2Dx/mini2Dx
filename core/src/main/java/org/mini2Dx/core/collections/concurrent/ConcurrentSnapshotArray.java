...
public class ConcurrentSnapshotArray<T> extends SnapshotArray<T> implements ConcurrentCollection {

    protected ReadWriteLock lock = Mdx.locks.newReadWriteLock();

    public ConcurrentSnapshotArray() {
        super();
    }
    ...
    public ConcurrentSnapshotArray(boolean ordered, int capacity, Class arrayType) {
        super(ordered, capacity, arrayType);
    }

    public ConcurrentSnapshotArray(boolean ordered, int capacity) {
        super(ordered, capacity);
    }

    public ConcurrentSnapshotArray(boolean ordered, T[] array, int startIndex, int count) {
        super(ordered, array, startIndex, count);
    }

    public ConcurrentSnapshotArray(Class arrayType) {
        super(arrayType);
    }

    public ConcurrentSnapshotArray(int capacity) {
        super(capacity);
    }

    public ConcurrentSnapshotArray(T[] array) {
        super(array);
    }
