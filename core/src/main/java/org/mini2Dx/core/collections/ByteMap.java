...
public class ByteMap<V> implements Iterable<ByteMap.Entry<V>> {
    ...
    public ByteMap (ByteMap<? extends V> map) {
    ...
    public boolean equals (Object obj) {
        ...
        if (!(obj instanceof ByteMap)) return false;
        ByteMap<V> other = (ByteMap)obj;
