...
public class ConcurrentCharArray extends CharArray implements ConcurrentCollection {
     ...
     */
    public ConcurrentCharArray(boolean ordered, int capacity) {
     ...
     * @param array
     */
    public ConcurrentCharArray(CharArray array) {
        super(array);
    }
     ...
     * @param array
     */
    public ConcurrentCharArray(char[] array) {
        super(array);
    }
     ...
     * @param count
     */
    public ConcurrentCharArray(boolean ordered, char[] array, int startIndex, int count) {
    ...
    public char[] ensureCapacity(int additionalCapacity) {
        lock.lockWrite();
        char[] c = super.ensureCapacity(additionalCapacity);
        lock.unlockWrite();
        return c;
    }
