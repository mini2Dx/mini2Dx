...
public class Lwjgl3Mini2DxCursor implements Cursor {
	static final Array<Lwjgl3Mini2DxCursor> cursors = new Array<Lwjgl3Mini2DxCursor>();
	...
	static void dispose(Lwjgl3Mini2DxWindow window) {
		for (int i = cursors.size - 1; i >= 0; i--) {
			Lwjgl3Mini2DxCursor cursor = cursors.get(i);
