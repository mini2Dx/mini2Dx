...
public abstract class TilesetSource implements GameDataSerializable, Disposable {
	 ...
	 */
	public abstract void updateAnimatedTiles(float delta);

	/**
	 * Returns all animated tiles in this tileset source
	 * @return An empty Array if no animated tiles
	 */
	public abstract Array<Tile> getAnimatedTiles();

	/**
	 * Registers an animated tile in this tileset source
	 * @param tile The animated {@link Tile}
	 */
	public abstract void registerAnimatedTile(Tile tile);
