 ...
 *
 */
public class AndroidMini2DxSound implements Sound {
	final AndroidMini2DxAudio audio;
	final SoundPool soundPool;
	final AudioManager manager;
	final int soundId;
	final IntArray streamIds = new IntArray(8);

	AndroidMini2DxSound (AndroidMini2DxAudio audio, SoundPool pool, AudioManager manager, int soundId) {
		this.audio = audio;
		this.soundPool = pool;
	...
	public long play (float volume) {
		...
		audio.appendRecentSoundId(streamId);
		return streamId;
	}
