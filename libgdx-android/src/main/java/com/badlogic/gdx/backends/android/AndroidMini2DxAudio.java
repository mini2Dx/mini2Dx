 ...
 */
public class AndroidMini2DxAudio implements Audio {
	...
	@Override
	public org.mini2Dx.core.audio.Music newMusic(org.mini2Dx.core.files.FileHandle fileHandle) throws IOException {if (soundPool == null) {
